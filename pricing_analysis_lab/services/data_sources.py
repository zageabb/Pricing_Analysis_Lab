...
def load_request_dataset(file_id: str, sheet_name: str | None = None) -> SpreadsheetData:
    return load_spreadsheet(resolve_uploaded_file(file_id), sheet_name=sheet_name)
